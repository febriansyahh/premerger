                        ...
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <h5 class="card-title text-primary">Catatan Harian Penelitian</h5>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= site_url('admin/penelitian/catatan/detail/' . $this->variasi->encode($value->usulan_id)) ?>" class="btn btn-outline-primary btn-sm"><i class="bx bxs-detail"></i> Detail</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
