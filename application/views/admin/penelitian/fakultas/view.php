                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="form-group mt-4">
                            <a data-bs-toggle="modal" data-bs-target="#baseFaculty" class="btn btn-primary" type="button" style="color: white;">Tambah Master Fakultas</a>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $value->faculty_dean_name ?></td>
                                                    <td><?= $value->faculty_nip ?></td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#editFaculty" onclick="editableFaculty(this)" data-id="<?php echo $this->variasi->encode($value->faculty_id) . "~" . $value->faculty_name . "~" . $value->faculty_dean_name . "~" . $value->faculty_nip . "~" . $value->faculty_external ?>" class="btn btn-outline-primary btn-sm">Edit</a>
                                                        <a href="<?php echo site_url('admin/penelitian/fakultas/deletefakultas/' . $this->variasi->encode($value->faculty_id)) ?>" onclick="return confirm('Apakah yakin untuk menghapus data ini ?');" class="btn btn-outline-danger btn-sm">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Tambah Master Fakultas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo site_url('admin/penelitian/fakultas/savefakultas') ?>" method="post" enctype="multipart/form">
