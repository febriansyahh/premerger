                    ...
                    <div class=" container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    <div class="body">
                                        <h5 class="card-title text-primary">Report Usulan Penelitian</h5>
                                        <form role="form" method="post" action="<?php echo site_url('admin/penelitian/report/cari'); ?>">
                                ...
                                if ($show == true) { ?>
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('admin/penelitian/report/exportexcel'); ?>" method="post" enctype="multipart/form" class="mb-3" target="_blank">
