                    ...
                    <div class=" container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    <div class="body">
                                        <h5 class="card-title text-primary">Laporan Dana Penelitian</h5>
                                        <form role="form" method="post" action="<?php echo site_url('admin/penelitian/report/caridata'); ?>">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            ...
                                                            <option value="" selected>Pilih</option>
                                                                ...
                                                                <option value="2">LOLOS DENGAN REVISI</option>
                                                                <option value="3">LOLOS DENGAN REVISI</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                ?>
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('admin/penelitian/report/exportdana'); ?>" method="post" enctype="multipart/form" class="mb-3" target="_blank">
