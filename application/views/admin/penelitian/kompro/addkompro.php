                            ...
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    ...
                                    <div class="col-xxl">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo base_url('admin/penelitian/kompro/savekompro'); ?>" method="post" enctype="multipart/form">
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Komponen</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="komponen" class="form-control" id="">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Indikator Penilaian</label>
                                                    <div class="col-sm-10">
                                                        <textarea name="indikator" class="form-control" id="content" cols="80" rows="50"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Bobot</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="bobot" class="form-control" id="">
                                                    </div>
                                                </div>

                                                <div class="row justify-content-end">
                                                    <div class="col-sm-10 mt-4">
                                                        <a href="<?= site_url('admin/penelitian/kompro') ?> " class="btn btn-warning">Kembali</a>
