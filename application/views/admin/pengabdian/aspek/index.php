                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="form-group mt-4">
                            <a href="<?= site_url('admin/pengabdian/Aspek/tambah') ?>" class="btn btn-primary" type="button" style="color: white;">Tambah Aspek Penilaian</a>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <h5 class="card-title text-primary">Aspek Penilaian</h5>

                                    <table id="tableaspek" class="table table-bordered table-striped table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $value->nilai ?></td>
                                                    <td>
                                                        <a href="<?php echo site_url('admin/pengabdian/Aspek/edit/' . $this->variasi->encode($value->aspek_id)) ?>" class="btn btn-outline-primary btn-sm">Edit</a>
                                                        <a href="<?php echo site_url('admin/pengabdian/Aspek/delete/' . $this->variasi->encode($value->aspek_id)) ?>" onclick="return confirm('Apakah yakin untuk menghapus data ini ?');" class="btn btn-outline-danger btn-sm">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
