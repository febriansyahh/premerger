                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= site_url('admin/pengabdian/laporan/detailakhir/' . $this->variasi->encode($value->usulan_id)) ?>" class="btn btn-outline-primary btn-sm"><i class="bx bxs-detail"></i> Detail</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
