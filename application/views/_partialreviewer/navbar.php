 ...
 <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
     ...
     <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
         ...
         <ul class="navbar-nav flex-row align-items-center ms-auto">
             <?php
                if ($this->session->userdata('level') == 'abreviewer') {
                ?>
                     ...
                     <ul class="dropdown-menu">
                         ...
                         <?php
                            ...
                            if ($check_pusat_studi == '1') {
                                echo '<li><a class="dropdown-item" href="javascript:void(0);">Pusat Studi Penelitian</a></li>
                            ';
                            }
                             ...
                             <a class="dropdown-item" href="#">
                                 <div class="d-flex">
                                     ...
                                     <div class="flex-grow-1">
                                         ...
                                         <small class="text-muted" style="text-transform: capitalize;">Reviewer Pengabdian</small>
                                     </div>
                                 </div>
                             </a>
                         </li>
