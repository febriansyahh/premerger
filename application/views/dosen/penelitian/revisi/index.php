                        ...
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                    ...
                                    <table id="tablerevisi" class="table table-bordered table-striped table-hover " style="width:100%; overflow-x:auto;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data->propose_point ?></td>
                                                    <td><?= date("d-m-Y", strtotime($data->propose_date1)) . ' s/d ' . date("d-m-Y", strtotime($data->propose_date2)) ?></td>
                                                    <td>
                                                        <a href="<?= site_url('dosen/penelitian/pengajuan/revisidetail/' . $this->variasi->encode($data->propose_id)) ?>"  class="btn btn-outline-warning btn-sm"><i class="bx bxs-detail"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
