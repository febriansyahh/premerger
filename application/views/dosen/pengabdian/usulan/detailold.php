                        ...
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="card-body">
                                        ...
                                        <div class="tab-pane fade show active" id="navs-usulan" role="tabpanel">
                                            ...
                                            <table width="100%" class="table" border="0">
                                                <tr>
                                                    ...
                                                    <td width="4%">:</td>
                                                    <td width="84%"><input type="text" name="judul" class="form-control" value="<?php echo $data->judul ?>"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>Surel (e-mail)</td>
                                                    <td>:</td>
                                                    <td><input type="text" name="email" class="form-control" value="<?php echo $data->email_dosen ?>"></td>
                                                </tr>
                                    ...
                                    <!-- </div> -->
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="<?= site_url('dosen/pengabdian/Usulan') ?>" class="btn btn-primary">Kembali</a>
                                    <!-- </div> -->
                                </div>
                            </div>
                        </div>
