                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $value->kemajuan_ringkasan ?></td>
                                                    <td><?= $value->kemajuan_keyword ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url('/upload_file/pengabdian/pelaksanaan/' . $value->kemajuan_file);  ?>" target="_blank" title="Download <?php echo $value->kemajuan_file ?>"><span class="badge bg-primary"><?php echo substr($value->kemajuan_file, 0, 30) . '...'; ?></span></a>
                                                        <a href="<?php echo base_url('/upload_file/pengabdian/pelaksanaan/' . $value->luaran_satu);  ?>" style="margin-top: 5px ;" target="_blank" title="Download <?php echo $value->luaran_satu ?>"><span class="badge bg-primary"> <?php echo substr($value->luaran_satu, 0, 25) . '...'; ?> </span></a>
                                                        <a href="<?php echo base_url('/upload_file/pengabdian/pelaksanaan/' . $value->luaran_dua);  ?>" style="margin-top: 5px; margin-bottom: 5px;" target="_blank" title="Download <?php echo $value->luaran_dua ?>"><span class="badge bg-primary"><?php echo substr($value->luaran_dua, 0, 25) . '...'; ?></span></a>
                                                        <a href="<?php echo base_url('/upload_file/pengabdian/pelaksanaan/' . $value->luaran_tiga);  ?>" target="_blank" title="Download <?php echo $value->luaran_tiga ?>"><span class="badge bg-primary"><?php echo substr($value->luaran_tiga, 0, 25) . '...'; ?></span></a>
                                                    </td>
                                                    <td>
                                                        <a href="<?= site_url('dosen/pengabdian/laporan/deletekem/' . $this->variasi->encode($value->kemajuan_id) . '~' . $this->uri->segment('5')) ?>" onclick="return confirm('Apakah yakin untuk menghapus data ini ?');" class="btn btn-outline-danger btn-sm"><i class="bx bxs-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
